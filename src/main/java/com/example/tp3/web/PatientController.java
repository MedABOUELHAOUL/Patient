...
public class PatientController {
    ...
    @PreAuthorize("hasRole('Role_ADMIN')")
    public String save(@Valid Patient patient, BindingResult Bindingresult, @RequestParam(defaultValue = "0") int page ,
    ...
    public String editpatients(Model model, Long id, String keyword, int page) {
        ...
        if(patient==null) throw new RuntimeException("Patients Introuvable");
